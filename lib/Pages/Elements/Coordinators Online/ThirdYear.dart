                                            ...
                                            new MaterialPageRoute(
                                                builder: (context) => new AboutCoordinator(
                                                    coordinatorModel: new CoordinatorModel(
                                                        ...
                                                        'img']
                                                            .toString(),
                                                        i,snapshot.data.documents[i]['abt'].toString(),snapshot.data.documents[i]['mail'].toString(),snapshot.data.documents[i]['ocp'].toString(),3))));
                                      },
                                      child: Container(
                                        ...
                                        child: Column(
                                          children: <Widget>[
                                            ...
                                            Padding(
                                              ...
                                              ['name']
                                                  .toString(),
                                                style: TextStyle(color: Colors.white,fontSize: height/35.23529313 -2,),textAlign: TextAlign.center,
                                              ),
                                            ),
                                            Padding(
                                              padding:
                                              ...
                                              new MaterialPageRoute(
                                                  builder: (context) => new AboutCoordinator(
                                                      coordinatorModel: new CoordinatorModel(
                                                          ...
                                                          'img']
                                                              .toString(),
                                                          i + 1,snapshot.data.documents[i+1]['abt'].toString(),snapshot.data.documents[i+1]['mail'].toString(),snapshot.data.documents[i+1]['ocp'].toString(),3))));
                                        },
                                        child: Container(
                                            color: Color(0x00000000),
                                         //   height: height/35.23529313*10,
